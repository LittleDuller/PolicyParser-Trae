...
async def manual_test_interpretation():
    print("====== 初始化测试环境 ======")
    # 绕开 API 和全局路由，直接在内存中拉起我们的 AI 核心驱动
    agent = InterpretAgent()

    # 手硬编码一份想要调试的原生政策文本
    # 只要您在这里修改文本或者去 app/workflow/prompts 下修改 j2 模板，接下来就能立即看到效果变化，做到了 100% 隔离调试！
    test_content = """各功能区
...
贯彻落实稳定经济运行一揽子政策的措施》已经市政府研究同意，现印发给你们，请认真贯彻落实。
...
2.支持税收减免政策。全面落实研发费用加计扣除、中小微企业设备器具税前扣除政策。落实阶段性减征部分乘用车车辆购置税政策。2022年12月31日前,购置列入免征车辆购置税的新能源汽车车型目录的新能源汽车,免征车辆购置税。2023年12月31日前,从事二手车经销的纳税人销售其收购的二手车,由原按照简易办法依3%征收率减按2%征收增值税,改为减按0.5%征收增值税。（牵头单位:市税务局,责任单位：市
...
10.着力提高全社会研发投入水平，增强创新驱动的内生动力。对上年度入统的研发经费投入


达到


500万元且研发投入强度达到3%以上的企事业单位，积极争取补助奖励。对域内高校、科研院所与企业开展产学研合作的项目优先推荐支持，鼓励高校院所加大研发投入。（牵头单位：市
...
13.加大对科技企业贷款力度和市级科技创新券使用。深化与中国银行黄骅


支


行、建设银行黄骅支行、沧州银行黄骅支行等银行合作。落实《沧州市科技创新券实施细则》，优化科技金融支持方向，加强对高新技术企业贷款贴息的支持。（牵头单位：市
...
25.加快交通基础设施项目建设。优化区域综合立体交通网，积极配合国铁集团按要求完成津潍铁路前期工作，积极推进石衡沧港城际铁路征拆工作，保障石港铁路正常建设进度。加快交通基础设施项目建设，积极协调推进G228、沿海高速歧口互通等重点项目，全力推进歧口互通连接线、省道S215等项目建设。大力实施“四好农村路”提升工程，确保完成2022年目标任务。（牵头单位：市交通局、市发改局，责任单位：市自然资源和规划局、沧州港务集团）

四、促进消费和外资外贸发展

26.提振居民消费信心。出台“惠民生促消费稳经济”消费补贴活动方案，充分释放消费市场活力，助力限上贸易企业发展壮大，拉动我市经济快速增长。开展家用新车促销、和新能源汽车推广，通过多种促销活动，拉动汽车消费。（牵头部门：市
...
30.完善城市消费设施。健全社区商业配套设施，支持改造提升一批便民市场、便民消费服务中心。稳步推进基层社设施升级改造，提升城乡便民消费能力，对接五级为农综合服务平台，丰富综合服务站“政务+为农服务”功能。（牵头部门：市城管局、市
...
31.培育电商龙头企业。积极推进创建电子商务示范基地和示范企业。积极申报电子商务建设项目，帮助企业争取上级资金支持。（牵头部门：市
...
32.实施购房补贴政策。在我市范围内购买新建商品住宅的且在2022年12月31日前缴纳完毕契税的购房人，按照购买商品房买卖合同价格的1%金额发放购房补贴。每套商品房只能享受一次补贴


。


具体实施时间和金额以正式文件为准。（牵头部门：市住建局，责任单位：市财政局、市税务局、沧州银保监分局黄骅监管组）
...
34.建立稳外贸激励机制。充分调动我市发展对外贸易的积极性，严格按照沧州商务局制定的政策，申报外贸转型升级资金项目，为符合条件的企业申请上级项目资金。积极扩大出口信保覆盖面，增强出口企业接单信心。（牵头单位：市
...
35.全面落实外资奖励政策。严格落实《鼓励外商投资产业目录》和《沧州市招商引资鼓励措施十条》，积极为符合条件的外资企业申报省专项资金奖励，积极推动外资项目落户黄骅。（牵头单位：市
...
42.降低生产经营成本。行政事业性收费标准有上下限设置的,一律按下限执行。2022年中小微企业宽带和专线平均资费再降10%。(牵头单位：市发改局、市
...
44.保障“白名单”企业正常生产。将符合条件的重点产业链供应链“白名单”企业纳入生态环境监管正面清单,保障其在环保达标条件下不停产不限产。(牵头单位：市
...
45.积极申报“揭榜挂帅”项目。按照上级部署，2022年10月底前，积极组织企业申报“揭榜挂帅”高质量项目，促进企业攻克关键核心技术和“卡脖子”技术。（牵头单位：市
...
46.助力传统产业转型升级。按照《黄骅市县域科技创新跃升计划奖励资金管理使用办法（试行）》，利用跃升计划奖励资金对省市级认定的科技创新平台进行后补助，支持重大科技成果转化。（牵头单位：市
...
47.加强对科技企业服务。坚持问题导向和需求导向，持续推进各级科技特派员为企业开展精准服务，选派科技特派员驻企服务，进一步完善科技成果推送和对接服务。（牵头单位：市
...
54.支持自主创业和灵活就业。政府投资开发的创业就业孵化基地、双创基地、众创空间等载体安排30%左右的场地免费向高校毕业生创业者提供。毕业年度和离校2年内未就业高校毕业生灵活就业，给予不超过其实际缴费数额2/3的社会保险补贴。（牵头单位：市人社局，责任单位：市发改局、市教育局、市
...
61.大力推进奶业振兴。利用上级资金，对新建、扩建社会养殖场每个栏位补助1000元；乳企自建牧场每个栏位补助2000元；建设智能奶牛场每个补助30—100万元；升级改造家庭牧场每个补助30万元；开展胚胎移植每枚胚胎补助2500元；购买性控冻精每支补助75元；对获批国家级核心育种场的给予一次性奖补50万元；对在每年3—5月正常收购省内生鲜乳进行喷粉的乳企，按收购量的10%每吨补助500元；对全株玉米、苜蓿等收贮每吨补助不高于48.5元；对苜蓿种植每亩补助600元；对每新增年产万吨婴幼儿乳粉支持4000万元
...
50吨巴氏杀菌乳产能支持1000万元，其中奶酪、黄油和巴氏杀菌乳产能支持资金不超过总投资额的30%；对符合条件的引进年实际投资额10亿元、5亿元的奶业产业化项目，分别给予1000万元和500万元奖补。上述支持政策以当年省级下达的项目申报文件为准。我市将按照上级要求，积极争取相关资金支持。（牵头单位：市农业农村局）
...
67.免收小微企业不动产登记费。实行小微企业免收不动产登记费告知承诺制。小微企业作出书面承诺后，即免收相应的不动产登记费。个体工商户凭工商营业执照直接免收不动产登记费。（牵头单位：市自然资源和规划局、市财政局、市发改局、市
...
2022年12月31日（具体措施有明确执行期限的，从其规定）。国家、省、沧州市有相关规定的，从其规定。

政策解读:

[政策图解|黄骅市发布《关于贯彻落实省市稳定经济运行一揽子政策的措施》71条](http://www.huanghua.gov.cn/huanghua/ADD11388/202208/c3910c5420a94703a11d47f2ba66375a.shtml)"""
    # 手动组装 LangGraph 需要的数据状态基类 PolicyState
    mock_state = PolicyState(
        policy_content=test_content, interpretation=None, messages=[]
    )

    print(
        "\n🚀 正在载入 Prompt 模版，并向底层大模型（如千问 Qwen）发送解析请求中，请稍候..."
    )

    # 直接拿组装好的虚假 state ，触发执行真正的具体节点。不走复杂的图连线。
    result = await agent.interpretation_node(
        state=mock_state, config=RunnableConfig()
    )

    print("\n\n====== 🤖 LLM 解析输出结果 (Prompt 执行效果) ======\n")
...
if __name__ == "__main__":
    # 执行该脚本的快捷方式： python -m tests.test_prompt
    asyncio.run(manual_test_interpretation())
